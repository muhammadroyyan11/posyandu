      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="pull-right">
                          <a href="<?=url("lansia/add")?>" class="btn btn-secondary btn-flat"><i class="fa fa-file btn-icon-prepend"></i> Add</a>
          ...
          <div class="card-body card-dashboard">
            <form autocomplete="off" class="content-filter">
              <div class="row">
                                  ...
                                  <div class="form-group col-md-6">
                                          <input type="text" id="jenis_kelamin" class="form-control form-control-sm" placeholder="Jenis kelamin" />
                                      </div>

                                  <div class="form-group col-md-6">
                                          <input type="text" id="pemeriksaan" class="form-control form-control-sm" placeholder="Pemeriksaan" />
                                      </div>

                                  <div class="form-group col-md-6">
                                          <input type="text" id="pemberian_vitamin" class="form-control form-control-sm" placeholder="Pemberian vitamin" />
                                      </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('cpanel/lansia/export/')?>" method="post" accept-charset="utf-8">
        ...
        "type": "POST",
         "data": function(data) {
                                          data.nama = $("#nama").val();
                                                        ...
                                                        data.pemberian_vitamin = $("#pemberian_vitamin").val();
