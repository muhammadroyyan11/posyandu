    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <!-- <input type="text" class="form-control form-control-sm" placeholder="Jenis kelamin" name="jenis_kelamin" id="jenis_kelamin"> -->
          ...
          <div class="form-group">
            ...
            <textarea class="form-control text-editor" rows="3" data-original-label="pemeriksaan" name="pemeriksaan"></textarea>
            <div id="pemeriksaan"></div>
          </div>

          <div class="form-group">
            <label>Pemberian vitamin</label>
            <textarea class="form-control text-editor" rows="3" data-original-label="pemberian_vitamin" name="pemberian_vitamin"></textarea>
            <div id="pemberian_vitamin"></div>
          </div>
